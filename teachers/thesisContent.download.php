...
<?php
  require_once '../include.php';
   ...
   //session_start();
  $id=$_SESSION['id'];
  $thesis = fetchAll("select name,number,file_name,total_table.type from student_choose_thesis_title,thesis_title,total_table,user where total_table.type='thesis_final' and user.id=total_table.upload_user_id and student_choose_thesis_title.student_id=user.id and thesis_title.id = student_choose_thesis_title.thesis_title_id and thesis_title.teacher_id='$id'");
  //print_r($thesis);

?>
<!--
       <div style="float:right;padding:5px 20px 5px;">
         <form method="get" action="thesisContent.download.search.php">
