...
if($error==UPLOAD_ERR_OK)
{
    ...
    $file = array('file_name'=>"'$filename'",
	 ...
	 $result = mysql_query("update total_table set file_name='$filename',file_type='$type',file_size='$size',upload_time='$time' where upload_user_id='$id' and type='$thesis_type'");
