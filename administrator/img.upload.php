...
if($error==UPLOAD_ERR_OK)
{
    ...
    $file = array('file_name'=>"'$filename'",
     ...
     if($result)
		    echo "<script language=\"JavaScript\">alert(\"文件.$filename.上传成功\");window.location.href='img.php';</script>";
    else
	    echo "<script language=\"JavaScript\">alert(\"文件.$filename.上传失败\");window.location.href='img.php';</script>";
    }else
       echo "<script language=\"JavaScript\">alert(\"上传文件出错\");window.location.href='img.php';</script>";
}
